<?php
/**
 * Decidiq DemoDataService.
 *
 * Imports `lib/Settings/decidiq_mock_register.json` — a `type: mock` descriptor generated from this
...
class DemoDataService {
	 ...
	 * @var string
	 */
	private const DESCRIPTOR = '/lib/Settings/decidiq_mock_register.json';
