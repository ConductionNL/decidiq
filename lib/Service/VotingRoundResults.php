...
/**
 * Rule-aware tallying for a voting round.
 *
 * @spec openspec/specs/voting-system/spec.md
 */
class VotingRoundResults
{
    ...
    public function tally(string $votingRoundId): array
    {
        ...
        $counts = $this->countVotes(voteEntities: $this->votes->allInRound(votingRoundId: $votingRoundId));
    ...
    public function saveShowOfHands(string $votingRoundId, int $votesFor, int $votesAgainst, int $votesAbstain): array
    {
        ...
        // #302: Validate submitted counts against the actual participant count.
