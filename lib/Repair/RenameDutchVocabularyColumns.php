...
class RenameDutchVocabularyColumns implements IRepairStep {
	...
	private const COLUMN_MAP = [
		...
		'afdoenings_bewijs' => 'afdoenings_evidence',
		'afdoenings_toelichting' => 'afdoenings_notes',
		'afgedane_toezegging' => 'afgedane_commitment',
		...
		'behandeling_verslag' => 'handling_verslag',
		...
		'betreft_jaar' => 'betreft_year',
		'beëdigings_datum' => 'be_digings_date',
		'beëdigings_vergadering' => 'be_digings_meeting',
		'bijlagen' => 'attachments',
		'board_koppeling' => 'board_integration',
		'boekjaar' => 'financial_year',
		'bron_schriftelijke_vraag' => 'source_written_question',
		'commissie_datum' => 'commissie_date',
		'current_versienummer' => 'current_version_number',
		'cyclus_stap' => 'cyclus_step',
		'delegataris_functie' => 'delegataris_role',
		'delegataris_persoon' => 'delegataris_person',
		'einde_datum' => 'end_date',
		'einde_reden' => 'end_reason',
		'einde_termijn_datum' => 'end_term_date',
		'exit_bevestigd_door' => 'exit_bevestigd_by',
		'exit_bevestigd_op' => 'exit_bevestigd_on',
		'externe_naam' => 'externe_name',
		'functie' => 'role',
		'gegenereerd_door' => 'gegenereerd_by',
		'gegenereerd_op' => 'gegenereerd_on',
		'geldig_tot' => 'valid_to',
		...
		'gesteld_door' => 'gesteld_by',
		'gesteld_op' => 'gesteld_on',
		'gever' => 'giver',
		...
		'integriteits_notificatie_groep' => 'integrity_notification_groep',
		'interpellatie_steun_drempel_type' => 'interpellation_steun_threshold_type',
		'interpellatie_steun_drempel_waarde' => 'interpellation_steun_threshold_value',
		...
		'reden' => 'reason',
		'reden_vervallen' => 'reason_vervallen',
		'referentie' => 'reference',
		'related_dossier' => 'related_file',
		'rooster' => 'schedule',
		'samenvatting' => 'summary',
		'technische_vragen_eind' => 'technical_vragen_end',
		'technische_vragen_start' => 'technical_vragen_start',
		'termijn_duur_maanden' => 'term_duration_months',
		'termijn_nummer' => 'term_number',
		'toetredings_datum' => 'toetredings_date',
		'uittredings_datum' => 'uittredings_date',
		'uren_indicatie' => 'hours_indication',
		'vastgesteld_door' => 'determined_by',
		'vaststellend_orgaan' => 'vaststellend_body',
		...
		'vervolg_schriftelijke_vraag' => 'vervolg_written_question',
		'vervolg_toezegging' => 'vervolg_commitment',
		'verwerking' => 'processing',
		'verwerkings_toelichting' => 'verwerkings_notes',
