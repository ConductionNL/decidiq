 ...
 * 2.39.0 ships neither formatter, so decidiq carries this copy. The names are
 * the contract's, so the copies across the fleet stay interchangeable.
 *
 ...
 */
export const INTEGRIQ_CONNECTIONS_PATH = '/apps/integriq/connections?app=decidiq&link=1'
