...
export default {
	...
	data() {
		return {
			repo: loadState('decidesk', 'features_roadmap_repo', 'ConductionNL/decidesk'),
			features: loadState('decidesk', 'features_roadmap_features', []),
			disabled: loadState('decidesk', 'features_roadmap_disabled', false),
		}
	},
}
</script>
