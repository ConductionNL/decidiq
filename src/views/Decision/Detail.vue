...
export default {
	...
	computed: {
		...
		subtitle() { return this.object?.outcome || '' },
		detailData() {
			if (!this.object) return []
			return [
				{ label: t('decidesk', 'Title'), value: this.object.title },
				{ label: t('decidesk', 'Text'), value: this.object.text },
				{ label: t('decidesk', 'Decision Date'), value: this.object.decisionDate },
				{ label: t('decidesk', 'Outcome'), value: this.object.outcome },
				{ label: t('decidesk', 'Is Published'), value: this.object.isPublished },
				{ label: t('decidesk', 'Published At'), value: this.object.publishedAt },
				{ label: t('decidesk', 'Legal Basis'), value: this.object.legalBasis },
			]
		},
	},
	async created() {
	...
	methods: {
		async loadObject() {
			...
			const objects = await store.fetchObjects('decision')
