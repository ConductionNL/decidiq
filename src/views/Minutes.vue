...
<!--
 @spec openspec/changes/p2-minutes-and-decisions/tasks.md#task-5.1
-->
<template>
	<CnIndexPage
		...
		<template #create-dialog="{ close }">
			<CnSchemaFormDialog
				:schema="schema"
				:title="t('decidesk', 'Notulen aanmaken')"
...
/**
 * Minutes list view showing all meeting records with lifecycle status.
 *
 * @spec openspec/changes/p2-minutes-and-decisions/tasks.md#task-5.1
 */
export default {
