...
<script>
import { CnChartWidget, CnDashboardPage, CnKpiGrid, CnStatsBlock } from '@conduction/nextcloud-vue'
...
export default {
	...
	async created() {
		...
		try {
			// _limit: 999 for meetings to load all objects for lifecycle grouping.
			// Silently undercounts above 999 — acceptable at current scale; move to
			// a backend stats endpoint if the meeting count grows beyond that.
