OC.L10N.register(
    "decidiq",
    {
        ...
        "A governance event (decision, meeting, vote or resolution) happened in Decidiq": "Ένα γεγονός διακυβέρνησης (απόφαση, συνεδρίαση, ψηφοφορία ή ψήφισμα) έγινε στο Decidiq",
        ...
        "Channel": "Κανάλι",
        "Choose which Decidiq events notify you and how they are delivered.": "Επιλέξτε ποια γεγονότα Decidiq σας ειδοποιούν και πώς παραδίδονται.",
        ...
        "Configure the OpenRegister schema mappings for all Decidiq object types.": "Ρύθμιση αντιστοιχίσεων σχήματος OpenRegister για όλους τους τύπους αντικειμένων Decidiq.",
        ...
        "Control how Decidiq presents itself for your account.": "Ελέγξτε πώς εμφανίζεται το Decidiq για τον λογαριασμό σας.",
        "Correction": "Διόρθωση",
        ...
        "Decidiq": "Decidiq",
        "Decidiq governance": "Διακυβέρνηση Decidiq",
        "Decidiq personal settings": "Προσωπικές ρυθμίσεις Decidiq",
        "Decidiq settings": "Ρυθμίσεις Decidiq",
        "Decision": "Απόφαση",
        ...
        "During the configured period your delegate receives your Decidiq notifications and can follow your pending votes and action items.": "Κατά τη διαμορφωμένη περίοδο, ο εντολοδόχος σας λαμβάνει τις ειδοποιήσεις Decidiq και μπορεί να παρακολουθεί τις εκκρεμείς ψηφοφορίες και στοιχεία δράσης σας.",
        "Dutch": "Ολλανδικά",
        ...
        "Information about the current Decidiq installation": "Πληροφορίες για την τρέχουσα εγκατάσταση Decidiq",
        ...
        "Manage the OpenRegister configuration for Decidiq.": "Διαχείριση διαμόρφωσης OpenRegister για Decidiq.",
        "Markdown": "Markdown",
        ...
        "Welcome to Decidiq!": "Καλώς ήρθατε στο Decidiq!",
        "Welcome to Decidiq! Get started by setting up your first governing body in Settings.": "Καλώς ήρθατε στο Decidiq! Ξεκινήστε ρυθμίζοντας τον πρώτο σας φορέα διακυβέρνησης στις Ρυθμίσεις.",
        "What was discussed…": "Τι συζητήθηκε…",
        "When": "Πότε",
        "Where Decidiq sends governance communications such as convocations, minutes and reminders.": "Πού το Decidiq στέλνει ανακοινώσεις διακυβέρνησης όπως προσκλήσεις, πρακτικά και υπενθυμίσεις.",
        ...
        "Meetings and attendance": "Συνεδριάσεις και παρουσίες",
        "Rounds held": "Γύροι που διεξήχθησαν",
        "Rounds adopted": "Γύροι που εγκρίθηκαν",
        "Rounds tied": "Ισόψηφοι γύροι",
        "Published publicly": "Δημοσιευμένο δημόσια",
        "Recorded absences": "Καταγεγραμμένες απουσίες",
        "By outcome": "Ανά έκβαση",
        "By result": "Ανά αποτέλεσμα",
        "By method": "Ανά μέθοδο",
        "By stage": "Ανά στάδιο",
        "By type": "Ανά τύπο",
        "How votes fell": "Πώς έπεσαν οι ψήφοι",
        "In person, digital or hybrid": "Δια ζώσης, ψηφιακά ή υβριδικά",
        "Most recent rounds": "Πιο πρόσφατοι γύροι",
        "No meetings yet": "Δεν υπάρχουν συνεδριάσεις ακόμη",
        "No voting rounds yet": "Δεν υπάρχουν γύροι ψηφοφορίας ακόμη",
        "Method": "Μέθοδος",
        "Stage": "Στάδιο",
