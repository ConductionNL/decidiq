...
- Name: workflows/voting-quorum-workflow.spec.ts >> casting a vote returns the persisted vote (no return-type 500)
- Location: tests/e2e/workflows/voting-quorum-workflow.spec.ts:262:5
