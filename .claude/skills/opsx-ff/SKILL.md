...
- **design.md MUST include a Seed Data section** (ADR-016): research realistic objects per schema with general organization data (municipality, consultancy, travel agency). The apply agent generates `_registers.json` entries from this section
