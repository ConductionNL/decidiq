 ...
 * `DECIDIQ_E2E_ALLOW_SHARED_INSTANCE` (or the fleet-wide
 ...
 * @throws when no target is configured outside CI, or when the target is the
 * shared development instance and no flag names it
 */
