...
use OCA\Decidiq\BackgroundJob\ConnectionReportJob;
 ...
 *
 * @covers \OCA\Decidiq\BackgroundJob\ConnectionReportJob
 */
class ConnectionReportJobTest extends TestCase {
	 ...
	 *
	 * A shorter interval would write a row on integriq far more often than a
	 * binding can change.
	 *
	 * @return void
	 */
