...
return [
    'routes' => [
        ...
        // Motion lifecycle routes — specific routes before wildcard {slug} routes (task-1.3).
        ...
        // VotingRound routes — specific routes before wildcard (task-2.3).
        ['name' => 'voting#openRound',   'url' => '/api/voting-rounds',             'verb' => 'POST'],
