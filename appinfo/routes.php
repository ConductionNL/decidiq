...
return [
    'routes' => [
        ...
        // Motion lifecycle — specific routes BEFORE wildcard {slug} route. (#18)
        ...
        // Amendment lifecycle. (#18)
        ['name' => 'motion#amendment_transition', 'url' => '/api/amendments/{id}/transition', 'verb' => 'POST'],

        // Voting rounds — specific routes BEFORE wildcard {slug} route. (#18)
        ...
        ['name' => 'voting#grant_proxy', 'url' => '/api/voting-rounds/{id}/proxy',    'verb' => 'POST'],
