...
@e2e exclude ADR-006 addendum documentation/process assertion — governs future spec-review judgment (what a reviewer must check before folding schemas together), not a runtime/UI behaviour; all three scenarios under this requirement are of this kind.
