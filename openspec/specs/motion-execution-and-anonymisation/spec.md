...
The system SHALL satisfy the REQ-MET (Motion Execution Tracking) requirements specified below.
...
The system SHALL satisfy the REQ-VAN (Vote Anonymisation) requirements specified below.
...
The system SHALL satisfy the REQ-QLC (Quorum Calculator) requirements specified below.
...
The system SHALL satisfy the REQ-WRA (Written/Circular Resolution Approval) requirements specified below.
