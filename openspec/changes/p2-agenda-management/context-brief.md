...
## Features (52 total, sorted by market demand)

### Auto-create Talk conversation per decision/agenda item for informal deliberation
**demand: 477** (159 tender mentions) | Category: core

### Link minutes to agenda items
**demand: 449** (149 tender mentions) | Category: core

### Conduct open vote on agenda item
**demand: 349** (97 tender mentions) | Category: core

### instant access to agendas
**demand: 324** (15 tender mentions) | Category: security

### AI-Assisted Agenda Drafting with One-Click Board Book Publishing
**demand: 306** (100 tender mentions) | Category: core

### Digital Agenda Distribution
**demand: 302** (97 tender mentions) | Category: core

### meeting agendas
**demand: 286** (10 tender mentions) | Category: core

### Agenda Builder and Board Pack Publishing Workflow
**demand: 263** (85 tender mentions) | Category: core

### Agenda Tracking
**demand: 249** (44 tender mentions) | Category: core

### feedback on the agenda (e
**demand: 231** (33 tender mentions) | Category: core

### Agenda (Drag & Drop)
**demand: 229** (32 tender mentions) | Category: core

### me to clearly see the agenda
**demand: 213** (32 tender mentions) | Category: core

### Attach financial documents to agenda
**demand: 213** (32 tender mentions) | Category: core

### like agenda-driven discussions
**demand: 213** (32 tender mentions) | Category: core

### Online Government Meeting Agendas
**demand: 213** (32 tender mentions) | Category: core

### Publish complete agenda package
**demand: 192** (49 tender mentions) | Category: core

### Index video recording by agenda item
**demand: 185** (32 tender mentions) | Category: media

### Collaborative Agenda Access and Contribution for Participants
**demand: 185** (32 tender mentions) | Category: core

### Declare conflict of interest for agenda item
**demand: 185** (32 tender mentions) | Category: core

### Receive ALV invitation with complete agenda
**demand: 184** (32 tender mentions) | Category: core

### Process consent agenda items (hamerstukken)
**demand: 184** (32 tender mentions) | Category: core

### Compile and distribute MT agenda package
**demand: 184** (32 tender mentions) | Category: core

### Compose ALV agenda with all required items
**demand: 184** (32 tender mentions) | Category: core

### Link motion to agenda item
**demand: 175** (43 tender mentions) | Category: core

### Track BOB phase per agenda item
**demand: 142** (32 tender mentions) | Category: core

### Agenda builder
**demand: 137** | Category: agenda management
Create and organize agenda items with drag-and-drop ordering

### Agenda item types
**demand: 137** | Category: agenda management
Support for informational, discussion, and decision items

### Time allocation
**demand: 137** | Category: agenda management
Set estimated duration per agenda item

### Agenda publication
**demand: 137** | Category: agenda management
Publish agenda before meeting with attachments

### Agenda amendments
**demand: 137** | Category: agenda management
Add/remove/reorder items during a meeting (with chair approval)

### Recurring agenda items
**demand: 137** | Category: agenda management
Template items that appear on every meeting agenda

### Submit agenda item with supporting documents
**demand: 135** (45 tender mentions) | Category: core

### Agenda Item Copying with Speaker Lists and Attachments
**demand: 122** (40 tender mentions) | Category: core

### AI-Powered Agenda and Summary Workflows
**demand: 108** (35 tender mentions) | Category: ai

### Assign spokespersons per agenda item
**demand: 103** (34 tender mentions) | Category: core

### Agenda > CSV export: Column content from ‘Title’ is exported without numbering.
**demand: 101** (33 tender mentions) | Category: core

### Drag-and-drop agenda builder with time allocation, presenter assignment, and automatic numbering
**demand: 99** (32 tender mentions) | Category: core

### Flexible Agenda Export with Customization Options
**demand: 98** (32 tender mentions) | Category: core

### Propose items for the agenda
**demand: 98** (32 tender mentions) | Category: core

### Structured Meeting Agenda Management Framework
**demand: 34** (10 tender mentions) | Category: core

### Centralized Meeting Information and Workflow Management
**demand: 31** (10 tender mentions) | Category: core
...
### Agenda & Planning
**demand: 2** | Category: Care Management
Geïntegreerde agenda voor het plannen van afspraken en behandelingen

### Reusable Meeting Agenda Templates
**demand: 2** | Category: release-v17.2.0
From OpenProject 17.2.0 (2026-03-11)

### Template-Based Meeting Agenda Automation
**demand: 2** | Category: release-v17.2.0
From OpenProject 17.2.0 (2026-03-11)

### tools for managing agendas
**demand: 2** | Category: other

### Real-Time Agenda
**demand: 2** | Category: Resource Planning
Up-to-date agenda accessible anywhere with notifications for relevant changes

### Agenda Creation and File Distribution
**demand: 1** | Category: other

### Agenda Building and Distribution
**demand: 1** | Category: other

## User Stories (172 linked)

### Story 1: Zoom Integration
**Priority:** wont
As a IT administrator, I want to use zoom integration, so that meeting workflows connect seamlessly with existing tools.

### Story 2: Congressus Integration
**Priority:** wont
As a IT administrator, I want to use congressus integration, so that meeting workflows connect seamlessly with existing tools.

### Story 3: Cms Integration
**Priority:** wont
As a IT administrator, I want to use cms integration, so that meeting workflows connect seamlessly with existing tools.

### Story 4: System Integrations
**Priority:** wont
As a IT administrator, I want to use system integrations, so that meeting workflows connect seamlessly with existing tools.

### Story 5: Entity Management Integration
**Priority:** wont
As a IT administrator, I want to use entity management integration, so that meeting workflows connect seamlessly with existing tools.

### Story 6: Api Integrations
**Priority:** wont
As a IT administrator, I want to use api integrations, so that meeting workflows connect seamlessly with existing tools.

### Story 7: Livestream Integration
**Priority:** wont
As a IT administrator, I want to use livestream integration, so that meeting workflows connect seamlessly with existing tools.

### Story 8: Payment Integration
**Priority:** wont
As a IT administrator, I want to use payment integration, so that meeting workflows connect seamlessly with existing tools.

### Story 9: Esg Integration Tools
**Priority:** wont
As a IT administrator, I want to use esg integration tools, so that meeting workflows connect seamlessly with existing tools.

### Story 10: Agenda Building
**Priority:** wont
As a meeting organizer, I want to have agenda building capabilities, so that meetings are well-prepared and time is used efficiently.

### Story 11: Enterprise Ratings
**Priority:** wont
As a IT administrator, I want to have enterprise ratings capabilities, so that meeting workflows connect seamlessly with existing tools.

### Story 12: Hybride Alv
**Priority:** wont
As a meeting organizer, I want to have hybride alv capabilities, so that all participants have equal meeting experience regardless of location.

### Story 13: Proxy Processing Integration
**Priority:** wont
As a IT administrator, I want to use proxy processing integration, so that meeting workflows connect seamlessly with existing tools.

### Story 14: ir Integration
**Priority:** wont
As a IT administrator, I want to use ir integration, so that meeting workflows connect seamlessly with existing tools.

### Story 15: Time to Book
**Priority:** wont
As a meeting organizer, I want to have time-to-book capabilities, so that the platform meets diverse organizational needs.

### Story 16: Collaborative Agendas
**Priority:** wont
As a meeting organizer, I want to have collaborative agendas capabilities, so that meetings are well-prepared and time is used efficiently.

### Story 17: Agenda Builder
**Priority:** wont
As a meeting organizer, I want to use agenda builder, so that meetings are well-prepared and time is used efficiently.

### Story 18: Digital Agenda Distribution
**Priority:** wont
As a meeting organizer, I want to have digital agenda distribution capabilities, so that meetings are well-prepared and time is used efficiently.

### Story 19: Ris Integration
**Priority:** wont
As a IT administrator, I want to use ris integration, so that meeting workflows connect seamlessly with existing tools.

### Story 20: e Depot Integration
**Priority:** wont
As a IT administrator, I want to use e-depot integration, so that meeting workflows connect seamlessly with existing tools.
...
- **AgendaItem**: An item on a meeting agenda with type, time, and ordering → Meeting, Motion

## Other App Entities (do NOT redefine)

ActionItem, Amendment, Decision, DigitalDocument, GovernanceBody, Meeting, Minutes, MonetaryAmount, Motion, Offer, Order, Participant, Product, Report, Vote, VotingRound
