...
- [ ] 6.3 Verify lifecycle transition: schedule a draft meeting via UI, open it, pause it, resume it, close it — all state changes persist
- [ ] 6.4 Verify invalid transition (e.g. closing an already-closed meeting) returns 422 and shows no UI button
