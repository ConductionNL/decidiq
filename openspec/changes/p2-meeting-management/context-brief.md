...
## Features (20 total, sorted by market demand)
...
- **Meeting**: A scheduled governance meeting with agenda, participants, and lifecycle → GovernanceBody, AgendaItem

## Other App Entities (do NOT redefine)

ActionItem, AgendaItem, Amendment, Decision, DigitalDocument, GovernanceBody, Minutes, MonetaryAmount, Motion, Offer, Order, Participant, Product, Report, Vote, VotingRound
