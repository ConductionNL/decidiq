...
- [ ] `openspec validate popolo-decision-makers --strict` passes
- [ ] Register is valid JSON and the four schemas + seeds import cleanly
- [ ] `/api/ori/v1/persons` and `/memberships` serialize real Popolo objects
