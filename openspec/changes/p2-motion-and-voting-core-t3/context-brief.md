# Context Brief: Motion and Voting — Core T3
...
**Spec:** p2-motion-and-voting-core-t3
...
**Lives at:** Moties > detail T3 / Moties
...
**Why this is an extension:** This spec adds advanced motion lifecycle features (execution tracking, co-signatories, anonymized nominal votes, qualified majority verification, remote shareholder approvals) which are workflow extensions to the existing motion-and-voting capability, not new standalone entities.
...
## Features (26 total, spec-linked, sorted by market demand)

### Verify qualified majority and quorum for statute amendment
**demand: 39** (13 tender mentions) | Category: core

### Track amendment versions with diff view in Files sidebar
**demand: 39** (13 tender mentions) | Category: core

### Motion Submission
**demand: 39** (11 tender mentions) | Category: core

### Update motion execution status
**demand: 39** (11 tender mentions) | Category: core

### Track adopted motion execution
**demand: 39** (11 tender mentions) | Category: core
...
### Remote Shareholder Resolution Approval Without Meeting
**demand: 33** (10 tender mentions) | Category: core

### Collect motion co-signatories digitally
**demand: 33** (11 tender mentions) | Category: core

### Track motion status throughout lifecycle
**demand: 33** (11 tender mentions) | Category: core

### Quorum Calculator
**demand: 27** | Category: core

### Quorum Configuration
**demand: 22** (6 tender mentions) | Category: core

### Register attendance and verify quorum digitally
**demand: 20** (6 tender mentions) | Category: core

### Receive First Call Resolution Notifications
**demand: 15** (5 tender mentions) | Category: core

### Filter First Call Resolution Items
**demand: 15** (5 tender mentions) | Category: core

### Bulk Actions in First Call Resolution
**demand: 15** (5 tender mentions) | Category: core

### Filter Multi-Channel Support Resolution Items
**demand: 15** (5 tender mentions) | Category: core

### Receive Multi-Channel Support Resolution Notifications
**demand: 15** (5 tender mentions) | Category: core

### Bulk Actions in Multi-Channel Support Resolution
**demand: 15** (5 tender mentions) | Category: core

### Emulated CSS Media Feature Simulation for Testing
**demand: 14** (4 tender mentions) | Category: core

### Re-enable connector after outage resolution
**demand: 12** (4 tender mentions) | Category: core

### No voting or polling system
**demand: 11** (3 tender mentions) | Category: core

### Quorum Rules
**demand: 5** | Category: core

### RSVP Management With Quorum Tracking
**demand: 1** | Category: core

### Executive Quorum
**demand: 1** | Category: core

### Comment and vote on open extension proposals
**demand: unknown** | Category: core

### Track quorum achievement and attendance patterns
**demand: unknown** | Category: core

## User Stories (176 linked)

### Story 1: Reporting
**Priority:** wont
As a organizational leader, I want to have reporting capabilities, so that meeting effectiveness can be measured and improved.

### Story 2: Customized Reporting
**Priority:** wont
As a organizational leader, I want to have customized reporting capabilities, so that meeting effectiveness can be measured and improved.

### Story 3: Scoring Voting
**Priority:** wont
As a organizational leader, I want to have scoring-voting capabilities, so that meeting effectiveness can be measured and improved.

### Story 4: Election Reporting
**Priority:** wont
As a organizational leader, I want to have election-reporting capabilities, so that meeting effectiveness can be measured and improved.

### Story 5: Statute Amendments
**Priority:** wont
...
### Story 6: Digital Shareholder Registers
**Priority:** wont
As a urban planner, I want to have digital shareholder registers capabilities, so that input is connected to specific locations and contexts.

### Story 7: Delegation Rules
**Priority:** wont
As a meeting organizer, I want to have delegation rules capabilities, so that the platform meets diverse organizational needs.

### Story 8: Meeting Cost Calculator
**Priority:** wont
...
### Story 9: Meeting Roi Measurement
**Priority:** wont
As a organizational leader, I want to have meeting roi measurement capabilities, so that meeting effectiveness can be measured and improved.

### Story 10: Meeting Scoring
**Priority:** wont
As a organizational leader, I want to have meeting scoring capabilities, so that meeting effectiveness can be measured and improved.

### Story 11: Implementation Quality Metrics
**Priority:** wont
As a organizational leader, I want to have implementation quality metrics capabilities, so that meeting effectiveness can be measured and improved.

### Story 12: Cybersecurity Reporting
**Priority:** wont
As a organizational leader, I want to have cybersecurity reporting capabilities, so that meeting effectiveness can be measured and improved.

### Story 13: Roi Metrics
**Priority:** wont
As a organizational leader, I want to have roi metrics capabilities, so that meeting effectiveness can be measured and improved.

### Story 14: Ease of Use Scores
**Priority:** wont
As a organizational leader, I want to have ease of use scores capabilities, so that meeting effectiveness can be measured and improved.

### Story 15: Mandate usage reporting
**Priority:** should-have
As a controller, I want reports on mandate usage, so that I can identify patterns and risks

### Story 16: View cases on area map
**Priority:** should-have
As a district manager, I want to see active cases on a map of my district so that I can identify spatial patterns

**Acceptance Criteria:**
Cases plotted on map, filterable by type and status, clusters shown

### Story 17: KvK/BTW number lookup and validation
**Priority:** should-have
As a Dutch business owner, I want to look up and validate KvK and BTW numbers when adding a contact, auto-filling company details from the KvK register.

### Story 18: Estimate tax liability
**Priority:** should-have
As a freelancer, I want to see an estimated tax liability throughout the year, so that I can set aside enough money

### Story 19: Auto-categorize transactions
**Priority:** should-have
As a bookkeeper, I want transactions to be automatically categorized based on rules, so that I save time

### Story 20: Physical asset audit
**Priority:** should-have
As an external auditor, I want to verify physical assets against the register, so that existence is confirmed
...
### Model Exception and Escalation Paths in BPMN
A process designer adds boundary events, error catch events, and escalation flows to an existing BPMN model to handle edge cases such as missing information, specialist refusals, and deadline breaches without process suspension.
**Trigger:** Production incident reveals unhandled exception in a live process, or process analysis identifies known risk scenarios
**Desired outcome:** All known exception paths are modelled, tested, and result in controlled process states rather than suspended tokens
**Current pain:** Exception paths are often added as workarounds by case handlers rather than modelled; suspended process tokens accumulate and require manual IT intervention to resolve
**Frequency:** monthly

## Stakeholders (307 linked)
