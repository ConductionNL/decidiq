...
**Change:** p3-citizen-participation
**Type:** capability
**Entities:** CitizenVote (`schema:VoteAction`), CitizenPanel (`schema:Organization`), ParticipatoryBudget (`schema:Grant`), BudgetProposal (`schema:Proposal`), PublicConsultation (`schema:Event`), Deliberation (`schema:DiscussionForumPosting` container), Notification (`schema:Message`)
**OCP interfaces:** `IUserSession`, `IGroupManager`, `IL10N`, `IEventDispatcher`, `IMailer`
**ORI mappings:** Decisions → `/api/ori/v1/decisions`; Meetings → `/api/ori/v1/events` (existing)
...
<!-- ============================================================ -->
<!-- Capability: citizen-voting                                   -->
<!-- Schema.org: schema:VoteAction on CitizenVote entity         -->
<!-- ORI: not an ORI entity; excluded from ORI API               -->
<!-- ============================================================ -->
...
<!-- ============================================================ -->
<!-- Modified capability: meeting-management                     -->
<!-- BREAKING: adds isPublic boolean to Meeting entity           -->
<!-- Default: false — existing meetings unaffected              -->
<!-- CalDAV storage per ADR-002: stored as X-DECIDESK-PUBLIC     -->
<!-- ============================================================ -->
