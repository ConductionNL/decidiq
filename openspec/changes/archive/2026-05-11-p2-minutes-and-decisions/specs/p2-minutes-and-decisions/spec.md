...
<!-- ============================================================ -->
<!-- Capability: minutes-lifecycle                                -->
<!-- Schema.org: meeting:Report (Minutes entity)                 -->
<!-- Akoma Ntoso: FRBRManifestation for signed/published minutes  -->
<!-- ============================================================ -->
...
<!-- Capability: app-foundation (from p1-crud-operations)        -->
<!-- Delta: extend stores, routes, navigation, and dashboard     -->
