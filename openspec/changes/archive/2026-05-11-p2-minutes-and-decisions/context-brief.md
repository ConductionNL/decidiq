...
## Features (18 total, spec-linked, sorted by market demand)
...
- **ActionItem**: A follow-up task from a meeting decision
- **Decision**: A formal decision resulting from a vote
- **Minutes**: Official record of a meeting's proceedings

## Other App Entities (do NOT redefine)

AgendaItem, Amendment, Area, ContactDetail, DigitalDocument, GovernanceBody, Meeting, Membership, MonetaryAmount, Motion, Offer, Order, Participant, Person, Post, Product, Report, Speech, Vote, VotingRound
