# Context Brief: Meeting Management — Core T2
...
**Spec:** p2-meeting-management-core-t2
**Spec Type:** extension (extends `p2-meeting-management`)
...
**Lives at:** Vergaderingen > detail (T2 expandable section) / Vergaderingen

**Rationale:** Tier-2 extension, collapsed by default  
_Source: /tmp/ia-doc-dec-cat-conn.md_

> **Implementation note for builders:** Respect the placement above. Do not promote this spec to a top-level menu item, sub-page, or new route unless the placement type explicitly says so. If the placement is `DETAIL_TAB`, `WIDGET`, `ACTION`, `SETTING`, or `INFRA`, the feature must NOT introduce a new entry in the app sidebar. When in doubt, ask before creating a new top-level surface.

## EXTENSION CONTEXT — you are extending `p2-meeting-management`

This spec is a extension of the **Meeting Management** capability. Do NOT define new entities or build new CRUD — reuse what `p2-meeting-management` already provides. Your job is to add configuration, seed data, or workflow templates on top of that capability.

**Why this is an extension:** These features (KPI benchmarks, productivity correlation, board meeting mode, voice AI agent, analytics) are advanced configurations and analytical layers on top of existing meeting management, not a standalone new capability.

### Parent capability overview (excerpt from `p2-meeting-management` brief):
...
## Features (44 total, spec-linked, sorted by market demand)

### semantic meeting models
**demand: 223** (10 tender mentions) | Category: core

### Meeting Kpi Benchmarks
**demand: 223** (10 tender mentions) | Category: core
...
**demand: 181** (28 tender mentions) | Category: core

### Meeting Archive
**demand: 165** (17 tender mentions) | Category: core

### Meeting Free Time Blocks
**demand: 164** (21 tender mentions) | Category: core

### Track document read confirmation per member for meeting preparation
**demand: 153** (51 tender mentions) | Category: core

### Board Meeting Mode
**demand: 153** (50 tender mentions) | Category: core

### Meeting Analytics
**demand: 150** (22 tender mentions) | Category: core

### Voice AI Meeting Agent
**demand: 140** (10 tender mentions) | Category: core

### Virtual Meeting Best Practices
**demand: 138** (13 tender mentions) | Category: core

### Meeting Calendar
**demand: 136** (40 tender mentions) | Category: core

### Meeting Metrics
**demand: 129** (10 tender mentions) | Category: core

### End to End Meeting Lifecycle
**demand: 129** (10 tender mentions) | Category: core

### Extractive Meeting Summarization
**demand: 127** (10 tender mentions) | Category: core

### Meeting Invitation Trend Visualizations
**demand: 127** (10 tender mentions) | Category: core

### Auto-transcribe meeting recordings
**demand: 126** (10 tender mentions) | Category: core

### Meeting Recording Captions
**demand: 126** (10 tender mentions) | Category: core

### Unlimited Chat and Meeting Capabilities
**demand: 126** (10 tender mentions) | Category: core

### Meeting Checklist
**demand: 126** (10 tender mentions) | Category: core

### Track and enforce meeting preparation compliance
**demand: 113** (35 tender mentions) | Category: core

### meeting center: schedule
**demand: 107** (34 tender mentions) | Category: core

### Generate periodic meeting audit reports
**demand: 105** (35 tender mentions) | Category: core

### Meeting Cost Calculator
**demand: 93** (10 tender mentions) | Category: core

### Meeting Culture Reform
**demand: 91** (10 tender mentions) | Category: core

### Comprehensive Meeting Culture Analytics Dashboard
**demand: 90** (10 tender mentions) | Category: core

### Access meeting recordings immediately
**demand: 82** (26 tender mentions) | Category: core

### LLM meeting analysis
**demand: 75** (24 tender mentions) | Category: core

### Meeting Summaries
**demand: 72** (24 tender mentions) | Category: core

### Cost Per Meeting Tracking
**demand: 65** (20 tender mentions) | Category: core

### View organizational meeting health report with benchmarks
**demand: 60** (20 tender mentions) | Category: core

### Meeting Notes and Templates for All Meeting Types
**demand: 58** (10 tender mentions) | Category: core

### Cross-Department Meeting Data Sharing and Access
**demand: 58** (19 tender mentions) | Category: core

### Hybrid Meeting Support
**demand: 57** (17 tender mentions) | Category: core

### Export Aesthetics Committee Meeting data
**demand: 51** (17 tender mentions) | Category: core

### Assess meeting necessity before scheduling
**demand: 46** (10 tender mentions) | Category: core

### Real-Time Meeting Transcription and Summarization
**demand: 46** (11 tender mentions) | Category: core

### Real Time Meeting Cost Ticker
**demand: 43** (11 tender mentions) | Category: core

### Meeting Transcription and Analysis
**demand: 42** (10 tender mentions) | Category: core

### Meeting Reduction Strategies
**demand: 41** (12 tender mentions) | Category: core

### Internal Notes for Committee Meeting Activities
**demand: 39** (13 tender mentions) | Category: core

### Receive notifications for Aesthetics Committee Meeting
**demand: 39** (13 tender mentions) | Category: core

### Live Meeting Mode
**demand: 39** (11 tender mentions) | Category: core

### Prepare steering committee meeting
**demand: 38** (12 tender mentions) | Category: core

## User Stories (752 linked)

### Story 1: Productivity Analytics
**Priority:** wont
As a organizational leader, I want to have productivity analytics capabilities, so that meeting effectiveness can be measured and improved.

### Story 2: Agenda Design
**Priority:** wont
...
### Story 4: Calendar Optimization
**Priority:** wont
As a meeting organizer, I want to have calendar optimization capabilities, so that meetings are well-prepared and time is used efficiently.

### Story 5: Scheduling Optimization
**Priority:** wont
...
### Story 6: End to End Encryption
**Priority:** wont
As a compliance officer, I want to have end-to-end encryption capabilities, so that organizational data and processes remain secure and compliant.

### Story 7: Role Based Permissions
**Priority:** wont
As a compliance officer, I want to have role-based permissions capabilities, so that organizational data and processes remain secure and compliant.

### Story 8: Virtual Meeting Best Practices
**Priority:** wont
As a meeting organizer, I want to have virtual meeting best practices capabilities, so that all participants have equal meeting experience regardless of location.

### Story 9: Agenda Compliance
**Priority:** wont
As a compliance officer, I want to have agenda compliance, so that organizational data and processes remain secure and compliant.

### Story 10: Security Assessment
**Priority:** wont
As a compliance officer, I want to have security assessment capabilities, so that organizational data and processes remain secure and compliant.

### Story 11: Risk Assessment Dashboards
**Priority:** wont
As a organizational leader, I want to use risk assessment dashboards, so that meeting effectiveness can be measured and improved.

### Story 12: Transparency Reporting
**Priority:** wont
As a organizational leader, I want to have transparency reporting capabilities, so that meeting effectiveness can be measured and improved.

### Story 13: Board Effectiveness Benchmarks
**Priority:** wont
As a organizational leader, I want to have board effectiveness benchmarks capabilities, so that meeting effectiveness can be measured and improved.

### Story 14: Board Ready Esg Dashboards
**Priority:** wont
As a organizational leader, I want to use board-ready esg dashboards, so that meeting effectiveness can be measured and improved.

### Story 15: Technology Adoption Benchmarks
**Priority:** wont
As a organizational leader, I want to have technology adoption benchmarks capabilities, so that meeting effectiveness can be measured and improved.

### Story 16: Performance Benchmarking
**Priority:** wont
As a organizational leader, I want to have performance benchmarking capabilities, so that meeting effectiveness can be measured and improved.

### Story 17: Analytics Dashboard
**Priority:** wont
As a organizational leader, I want to use analytics dashboard, so that meeting effectiveness can be measured and improved.

### Story 18: ai Analytics
**Priority:** wont
As a organizational leader, I want to have ai analytics capabilities, so that meeting effectiveness can be measured and improved.

### Story 19: Real Time Analytics
**Priority:** wont
As a organizational leader, I want to have real-time analytics capabilities, so that meeting effectiveness can be measured and improved.

### Story 20: Deliberation Benchmarks
**Priority:** wont
As a organizational leader, I want to have deliberation benchmarks capabilities, so that meeting effectiveness can be measured and improved.
