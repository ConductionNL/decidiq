# Delta Spec: meeting-series

**Change:** p2-meeting-management-core-t1
**Capability:** meeting-series — Recurring meeting patterns with recurrence rules and series grouping
**Schema.org type:** `meeting:Meeting` (Popolo: `Event`)
