# Delta Spec: meeting-detail-view

**Change:** p2-meeting-management-core-t1
**Capability:** meeting-detail-view — Meeting detail page with related entities, edit form, and action buttons
**Components:** `CnDetailPage`, `CnDetailCard`, `CnFormDialog`, `CnObjectSidebar`, `CnStatusBadge`, `CnTimelineStages`
