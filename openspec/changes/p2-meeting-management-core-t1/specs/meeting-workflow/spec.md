# Delta Spec: meeting-workflow

**Change:** p2-meeting-management-core-t1
**Capability:** meeting-workflow — Lifecycle state machine per governance domain
**Schema.org type:** `schema:Action` (lifecycle transitions)
