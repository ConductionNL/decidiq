...
- DigiD-gated PUBLIC access to besloten stukken (portal-side authentication) — decidiq's public surface stays the OR published-predicate + OpenCatalogi route.
