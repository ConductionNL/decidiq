# Context Brief: Motion and Voting — Core T2
...
**Spec:** p2-motion-and-voting-core-t2
...
**Lives at:** Moties > detail T2 / Moties
...
## Features (36 total, spec-linked, sorted by market demand)

### Resolution Tracking
**demand: 288** (69 tender mentions) | Category: core

### Real-Time Vote Tabulation and Compliance Reporting
**demand: 288** (94 tender mentions) | Category: core

### Meeting Polls
**demand: 285** (10 tender mentions) | Category: core

### Online Voting Platform for Various Vote Types
**demand: 271** (84 tender mentions) | Category: core

### Split Vote Distribution Across Multiple Candidates
**demand: 256** (66 tender mentions) | Category: core

### Individual Member Voting Behavior Tracking
**demand: 253** (65 tender mentions) | Category: core

### Access standardized resolution data
**demand: 247** (82 tender mentions) | Category: core

### Verify member voting rights
**demand: 230** (76 tender mentions) | Category: core

### Real-time voting and polling with multiple methods: show of hands, roll call, secret ballot, and weighted voting
**demand: 211** (66 tender mentions) | Category: core

### Motions > Voting: Simultaneously ending, publishing, and anonymizing roll-call votes is working again.
**demand: 206** (65 tender mentions) | Category: core

### Motions > Live voting: In the projection dialog, single votes are preselected when live voting is active.
**demand: 203** (66 tender mentions) | Category: core

### Pro/Con Voting with Toxicity Detection and AI Analysis
**demand: 202** (67 tender mentions) | Category: core

### Logout: The console no longer throws an error when logging out during a running vote.
**demand: 197** (65 tender mentions) | Category: core

### Settings > Default voting groups: The presets for voters are displayed and applied correctly.
**demand: 197** (65 tender mentions) | Category: core

### Communicate escalation resolution
**demand: 194** (62 tender mentions) | Category: core

### Quick Problem Resolution
**demand: 194** (62 tender mentions) | Category: core

### Motion Workflow
**demand: 174** (40 tender mentions) | Category: core

### Submit motion or proposal for ALV agenda
**demand: 168** (56 tender mentions) | Category: core

### Amendment Tracking
**demand: 165** (25 tender mentions) | Category: core

### Motion Tracking
**demand: 139** (23 tender mentions) | Category: core

### Access Complex Technical Issue Resolution on Mobile
**demand: 122** (30 tender mentions) | Category: core

### Emotional and Engagement Analytics for Meeting Summaries
**demand: 106** (11 tender mentions) | Category: core
...
### Access Multi-Channel Support Resolution on Mobile
**demand: 93** (31 tender mentions) | Category: core

### Motion Forwarding Permission Controls for Organization Admins
**demand: 89** (29 tender mentions) | Category: core

### Generate Multi-Channel Support Resolution Report
**demand: 69** (23 tender mentions) | Category: core

### Proposal Amendment
**demand: 68** (13 tender mentions) | Category: core

### Preview the resulting text after amendment
**demand: 68** (13 tender mentions) | Category: core

### Draft and coordinate statute amendment
**demand: 68** (13 tender mentions) | Category: core

### Motion Amendment Recommendation Extension and Shortening
**demand: 59** (19 tender mentions) | Category: core

### Export Multi-Channel Support Resolution Data
...
**demand: 44** (14 tender mentions) | Category: core

### Motions > Amendment: Diff version visualization with sorted lists is working correctly.
**demand: 44** (14 tender mentions) | Category: core

### Export Complex Technical Issue Resolution Data
**demand: 42** (14 tender mentions) | Category: core

### Draft amendment with inline text changes
**demand: 40** (13 tender mentions) | Category: core

### Draft motion from template
**demand: 39** (11 tender mentions) | Category: core

## User Stories (1095 linked)

### Story 1: Digital Oversight Models
**Priority:** wont
As a corporate secretary, I want to have digital oversight models capabilities, so that the platform meets diverse organizational needs.

### Story 2: Management Assessment
**Priority:** wont
As a corporate secretary, I want to have management assessment capabilities, so that the platform meets diverse organizational needs.

### Story 3: Subsidiary Governance
**Priority:** wont
As a corporate secretary, I want to have subsidiary governance capabilities, so that the platform meets diverse organizational needs.

### Story 4: Digitalisation Requirements
**Priority:** wont
As a corporate secretary, I want to have digitalisation requirements capabilities, so that the platform meets diverse organizational needs.

### Story 5: Agm Planning Workflows
**Priority:** wont
As a corporate secretary, I want to have agm planning workflows capabilities, so that the platform meets diverse organizational needs.

### Story 6: Retention Policies
**Priority:** wont
As a membership coordinator, I want to have retention policies capabilities, so that members stay engaged throughout their membership.

### Story 7: Shareholder Activism Monitoring
**Priority:** wont
As a corporate secretary, I want to have shareholder activism monitoring capabilities, so that the platform meets diverse organizational needs.

### Story 8: Predictive Risk Tools
**Priority:** wont
As a corporate secretary, I want to use predictive risk tools, so that the platform meets diverse organizational needs.

### Story 9: Governance Workflows
**Priority:** wont
As a corporate secretary, I want to have governance workflows capabilities, so that the platform meets diverse organizational needs.

### Story 10: Issuer Investor Communication
**Priority:** wont
As a corporate secretary, I want to have issuer-investor communication capabilities, so that the platform meets diverse organizational needs.

### Story 11: no Per User Fees
**Priority:** wont
As a corporate secretary, I want to have no per-user fees capabilities, so that the platform meets diverse organizational needs.

### Story 12: Nonprofit Friendly
**Priority:** wont
As a corporate secretary, I want to have nonprofit-friendly capabilities, so that the platform meets diverse organizational needs.

### Story 13: Member Engagement Tracking
**Priority:** wont
As a membership coordinator, I want to have member engagement tracking capabilities, so that members stay engaged throughout their membership.

### Story 14: Participant Identification
**Priority:** wont
As a corporate secretary, I want to have participant identification capabilities, so that the platform meets diverse organizational needs.

### Story 15: Virtual Participation
**Priority:** wont
As a corporate secretary, I want to have virtual participation capabilities, so that the platform meets diverse organizational needs.

### Story 16: Corporate Governance
**Priority:** wont
As a corporate secretary, I want to have corporate-governance capabilities, so that the platform meets diverse organizational needs.

### Story 17: Shareholder Rights in Virtual Settings
**Priority:** wont
As a corporate secretary, I want to have shareholder rights in virtual settings capabilities, so that the platform meets diverse organizational needs.

### Story 18: Membership Management
**Priority:** wont
As a membership coordinator, I want to have membership management capabilities, so that members stay engaged throughout their membership.

### Story 19: Legal Compliance Checklists
**Priority:** wont
As a compliance officer, I want to have legal compliance checklists capabilities, so that organizational data and processes remain secure and compliant.

### Story 20: Membership
**Priority:** wont
As a membership coordinator, I want to have membership capabilities, so that members stay engaged throughout their membership.

## Customer Journeys (15 linked)

### Vendor Risk Management
Assess and monitor supplier financial and operational risk
**Trigger:** New vendor onboarding; periodic review
**Desired outcome:** Risk-scored vendor portfolio; proactive risk mitigation
**Frequency:** quarterly
...
Self-service financial analytics and business intelligence
**Trigger:** Management question or KPI review
**Desired outcome:** Data-driven insights; self-service dashboards for all levels
**Frequency:** daily
